...
import (
	...
	"github.com/chillaxio/chillax/libunix"
...
func NewApplication() (*Application, error) {
	...
	dsn := libenv.EnvWithDefault("DSN", fmt.Sprintf("postgres://%v@localhost:5432/chillax?sslmode=disable", u))
	...
	cookieStoreSecret := libenv.EnvWithDefault("COOKIE_SECRET", "sM-0YK3nK7m9XC2h")
